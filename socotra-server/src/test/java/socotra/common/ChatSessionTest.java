...
public class ChatSessionTest {
    ...
    public void testConstructors() {
        chatSession1 = new ChatSession(SenderTest.generateTreeSet("admin", "admin1"), true, true, ChatSession.PAIRWISE);
    ...
    public void testGetToMembersAndSetMembers() {
        ...
        TreeSet<User> expected = SenderTest.generateTreeSet("admin");
    ...
    public void testEquals() {
        chatSession1 = new ChatSession(SenderTest.generateTreeSet("admin", "admin1"), true, true, ChatSession.PAIRWISE);
        chatSession2 = new ChatSession(SenderTest.generateTreeSet("admin", "admin1"), false, true, ChatSession.PAIRWISE);
        boolean actual = chatSession1.equals(chatSession2);
        assertTrue(actual);

        chatSession1 = new ChatSession(SenderTest.generateTreeSet("admin", "admin1"), true, true, ChatSession.PAIRWISE);
        chatSession2 = new ChatSession(SenderTest.generateTreeSet("admin1", "admin"), true, true, ChatSession.PAIRWISE);
        actual = chatSession1.equals(chatSession2);
        assertTrue(actual);

        chatSession1 = new ChatSession(SenderTest.generateTreeSet("admin", "admin1"), true, true, ChatSession.PAIRWISE);
        chatSession2 = new ChatSession(SenderTest.generateTreeSet("admin1", "admin"), true, true, ChatSession.GROUP);
        actual = chatSession1.equals(chatSession2);
        assertFalse(actual);

        chatSession1 = new ChatSession(SenderTest.generateTreeSet("admin", "admin1"), true, true, ChatSession.PAIRWISE);
        chatSession2 = new ChatSession(SenderTest.generateTreeSet("admin1", "admin"), true, false, ChatSession.PAIRWISE);
        actual = chatSession1.equals(chatSession2);
        assertFalse(actual);

        chatSession1 = new ChatSession(SenderTest.generateTreeSet("admin", "admin1"), true, true, ChatSession.PAIRWISE);
        chatSession2 = new ChatSession(SenderTest.generateTreeSet("admin2", "admin"), true, true, ChatSession.PAIRWISE);
        actual = chatSession1.equals(chatSession2);
        assertFalse(actual);
    }
